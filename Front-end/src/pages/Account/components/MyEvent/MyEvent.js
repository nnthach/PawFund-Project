...
import CreateEvent from '~/pages/Admin/components/Events/Components/CreateEvent';
...
function Blogs() {
    ...
    const handleBlogData = async () => {
        try {
            ...
            const response = await api.get(`posts/search?tags=Event&category=ADOPTION&userId=${userId}`, {
                headers: {
